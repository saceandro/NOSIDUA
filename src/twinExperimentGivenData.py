...
def main():
    ...
    T = 1.
    generation_seed = 1
    pref = "../data/" + lorenz.__class__.__name__ + "/N_"\
...
#    bounds = ((None, None), (None, None), (None, None), (None, None), (None, None), (0, None), (None, None))
    ...
    experimentUtil.twin_experiment_given_data_file(lorenz, true_p, pref + "true.tsv", pref + "observed.tsv", obs_variance, dt, T, trials, bounds, initial_guess_bounds, missing_values={'nan'})
#%%
